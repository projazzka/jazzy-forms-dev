...
class Arithmetics(unittest.TestCase):
    ...
    def test_arithmetics(self):
        ...
        self.assertEqual("0.12", driver.find_element_by_id("jzzf_10_percentage1").get_attribute("value"))
        self.assertEqual("3.12", driver.find_element_by_id("jzzf_10_percentage2").get_attribute("value"))
        self.assertEqual("1.2", driver.find_element_by_id("jzzf_10_percentage3").get_attribute("value"))
